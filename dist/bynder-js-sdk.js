...
function createAuthHeader(requestData, consumerToken, accessToken) {
    var oauth = new _oauth2.default({ consumer: consumerToken });
...
var APICall = function () {
     ...
     */
    function APICall(baseURL, httpsAgent, httpAgent, consumerToken, accessToken) {
        _classCallCheck(this, APICall);

        if (!(0, _isUrl2.default)(baseURL)) throw new Error('The base URL provided is not valid');
    ...
    _createClass(APICall, [{
        ...
        value: function send(method, url) {
            ...
            var callURL = (0, _properUrlJoin2.default)(this.baseURL, url, { trailingSlash: true });
            var headers = createAuthHeader({ url: callURL, data: data, method: method }, this.consumerToken, this.accessToken);
            var body = '';
            ...
            if (method === 'POST') {
                ...
                callURL = (0, _properUrlJoin2.default)(callURL, { trailingSlash: true, query: data });
            }
...
var Bynder = function () {
    ...
    function Bynder(options) {
        ...
        this.api = new APICall(options.baseURL, options.httpsAgent, options.httpAgent, options.consumer, options.accessToken);
    }
    ...
    _createClass(Bynder, [{
        ...
        value: function getRequestToken() {
            var api = new APICall(this.options.baseURL, this.options.httpsAgent, this.options.httpAgent, this.options.consumer, { public: null, secret: null });
        ...
        value: function getAuthorisedURL(token, callback) {
            var authoriseToken = (0, _properUrlJoin2.default)(this.baseURL, 'v4/oauth/authorise', {
                trailingSlash: true,
        ...
        value: function getAccessToken(token, secret) {
            return this.api.send('POST', 'v4/oauth/access_token/', { public: token, secret: secret });
        }
        ...
        value: function getMediaList() {
            ...
            return this.api.send('GET', 'v4/media/', _extends({}, params, {
                count: false
        ...
        value: function getAllMediaItems() {
            ...
            var recursiveGetAssets = function recursiveGetAssets(_params, assets) {
                ...
                return _this.getMediaList(params).then(function (data) {
        ...
        */
        ...
        value: function getAssetUsage(queryObject) {
            ...
            var request = new APICall(this.baseURL, 'media/usage/', 'GET', this.consumerToken, this.accessToken, { asset_id: queryObject.id });
            return request.send();
        }
        ...
        value: function saveNewAssetUsage(queryObject) {
            ...
            var request = new APICall(this.baseURL, 'media/usage/', 'POST', this.consumerToken, this.accessToken, {
        ...
        value: function deleteAssetUsage(queryObject) {
            ...
            var request = new APICall(this.baseURL, 'media/usage/', 'DELETE', this.consumerToken, this.accessToken, {
                asset_id: queryObject.id,
                integration_id: queryObject.integration_id,
                uri: queryObject.uri || null
            });
